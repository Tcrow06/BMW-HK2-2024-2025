...
<link rel="stylesheet" href="<c:url value='/static/js/web/header.css' />" />
...
<%--                        <li><a href="<c:url value="/danh-sach-san-pham?page=1&maxPageItem=9"/>">Thời trang</a></li>--%>
    ...
    <button id="chatRoomBtn" class="chat-room-btn">Thảo luận</button>

    <div id="chatRoom">
        <div id="chatRoomMessages"></div>
        <div id="chatRoomInputContainer">
            <input id="chatRoomInput" type="text" placeholder="Nhập tin nhắn...">
            <button id="sendChatRoomBtn">Gửi</button>
        </div>
    </div>
    ...
    <script src="<c:url value='/static/js/web/header.js'/>"></script>
